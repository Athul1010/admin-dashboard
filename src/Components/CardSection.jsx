        ...
        <a href="#" className="flex flex-col sm:flex-row items-center bg-white border border-gray-200 rounded-lg shadow dark:border-gray-700 dark:bg-gray-800 w-full">
            ...
            <div className="flex flex-col justify-between p-4 sm:p-6 leading-normal">
                ...
                <div className='flex gap-4'>
                    <button className='border border-black px-4 py-2 rounded-full text-sm sm:text-base font-semibold text-black'>Go</button>
                    <button className='border border-black px-4 py-2 rounded-full text-sm sm:text-base font-semibold text-black'>Request</button>
                </div>
            </div>
        </a>
        {/* Social Media */}
        ...
        <a href="#" className="flex flex-col bg-white border border-gray-200 rounded-lg shadow dark:border-gray-700 dark:bg-gray-800 w-full">
            <div className="flex flex-col justify-between p-4 sm:p-6 leading-normal">
                ...
                <div className='flex gap-4'>
                    ...
                    <button className='border border-black px-4 py-2 rounded-full text-sm font-semibold text-black'>Send</button>
                </div>
            </div>
        </a>
    </div>
